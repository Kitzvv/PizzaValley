function About() {
  return (
    <section className="bg-zinc-800" id="about">
      <div className="py-12 px-4 md:px-8 lg:px-16 xl:px-32 grid grid-cols-1 md:grid-cols-2 items-center mx-auto min-h-[40rem] gap-8 md:gap-20">
        ...
        <div className="mb-10 md:mb-0">
          <p className="mb-3 text-3xl md:text-4xl font-addition text-emerald-400">
            Poznaj nas od kuchni...
          </p>
          <p className="font-bold font-main text-gray-200 text-xl md:text-xl uppercase mb-2">
